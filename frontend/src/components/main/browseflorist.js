...
const Browseflorist = () => {
  ...
  return (
    <Container sx={{ mt: 8 }} >
    <Card style={{width:"1000px", display:"flex",  flexPosition:"row" }} sx={{ mt: 5 }}>
    ...
    <CardMedia
      ...
      <CardContent >        
        ...
        <Button variant="text"style = {{cursor:"pointer"}}>Price</Button>
        <Button variant="contained"style = {{cursor:"pointer"}}>Buy Now</Button>
        </Stack>
        </Box>
        </CardContent>
        </Container>
